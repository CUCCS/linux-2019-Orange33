...
function HelpInfo {
	...
	echo -e "Tips: Before using this script, use 'wget http://sec.cuc.edu.cn/huangwei/course/LinuxSysAdmin/exp/chap0x04/worldcupplayerinfo.tsv' to download worldcupplayerinfo.tsv\n"
